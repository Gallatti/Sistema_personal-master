...
<body id="page-top">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="https://trctaborda.com.br/">Serviços</a>
                    </li>
                    <li>
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 id="homeHeading">Área administrativa</h1>
                <hr>
    ...
    $('#bt-acessar').click(function() {
        ...
        if (login == '') {
            ...
            if (login < 3) arrErro.push('O login é menor que 3 caracteres');
        }

        if (senha == '') {
            arrErro.push('Campo Senha vazio');
        } else {
            if (senha < 3) arrErro.push('A senha é menor que 3 caracteres');
        }
